...
import {useGussList} from "@/composables/index"
      ...
      <view class="overview" v-if="menberStore.profile">
        <navigator url="/pagesMember/profile/profile" hover-class="none">
          <image
            class="avatar"
            mode="aspectFill"
            :src="menberStore.profile.avatar"
          ></image>
        </navigator>
        <view class="meta">
          <view class="nickname"> {{menberStore.profile.nickname || menberStore.profile.account}} </view>
