...
const onSubmit=async()=>{
  ...
  const res=await putMemberProfileAPI({
    ...
    gender,
    birthday,
    provinceCode:fullLocation.value[0],
    cityCode:fullLocation.value[1],
    countyCode:fullLocation.value[2]
  })
  // 更新store中用户昵称信息
